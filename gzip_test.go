...
func newServer() *zoox.Application {
	...
	router.Get("/", func(c *zoox.Context) {
		c.Set("Content-Length", strconv.Itoa(len(testResponse)))
		c.String(200, testResponse)
	})
	router.Any("/reverse", func(c *zoox.Context) {
...
func TestGzipPNG(t *testing.T) {
	...
	router := zoox.New()
	router.Use(Gzip(DefaultCompression))
	router.Get("/image.png", func(c *zoox.Context) {
...
func TestExcludedExtensions(t *testing.T) {
	...
	router.Get("/index.html", func(c *zoox.Context) {
...
func TestExcludedPaths(t *testing.T) {
	...
	router.Get("/api/books", func(c *zoox.Context) {
...
func TestDecompressGzip(t *testing.T) {
	...
	router.Post("/", func(c *zoox.Context) {
